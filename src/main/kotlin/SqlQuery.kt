...
private const val SELECT_ONE_IN_ORACLE_DB = "SELECT * FROM (SELECT ROWNUM AS NUM, * FROM"
...
private const val SELECT_ONE_IN_MYSQL = "SELECT * FROM"
private const val SELECT_ONE_LIMIT_IN_MYSQL = "LIMIT 1"
private const val SELECT_ALL_IN_MYSQL = "SELECT * FROM"
...
class SqlQuery {
    ...
    fun getSelectOneQuery(type: Byte, tabName: String): String {
        ...
        else "$SELECT_ONE_IN_MYSQL $tabName $SELECT_ONE_LIMIT_IN_MYSQL"
    }
    ...
    fun getSelectAllQuery(type: Byte, tabName: String, id: String, from: Long, to: Long): String {
        ...
        else "$SELECT_ALL_IN_MYSQL $tabName $SELECT_ALL_ORDER_BY_IN_MYSQL $id $SELECT_ALL_LIMIT_IN_MYSQL $from,$to"
    }
}